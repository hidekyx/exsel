<?php
    ...
    class Kriteria_model extends CI_Model {
        ...
        public function tampil($id_batch = null)
        {
        ...
        public function update_perioritas($id_kriteria,$perioritas)
        {
            $query = $this->db->simple_query("UPDATE kriteria_hasil SET nilai='$perioritas' WHERE id_kriteria='$id_kriteria';");
            return $query;	
        }
