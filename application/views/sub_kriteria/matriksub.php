...
$("#formentri").submit(function(e){
	...
	$.ajax({
		type:'post',
		dataType:'json',
		url:"<?=base_url();?>Sub_Kriteria/updatesub",
		data:$(this).serialize(),
		error:function(){
...
<div class="alert alert-info">
	Setelah mengisi nilai matrik perbandingan silahkan klik tombol <b>SIMPAN NILAI SUB KRITERIA</b> untuk meyimpan nilai matrik. Selanjutnya menekan tombol <b>SIMPAN NILAI PRIORITAS</b> untuk menyimpan nilai prioritas yang telah dihasilkan.
</div>
...
<h3>Matrik Perbandingan Berpasangan Sub Kriteria</h3>
<hr/>
...
<div class="pull-left">
	...
	<button type="submit" class="btn btn-success"><i class="fa fa-save"></i> Simpan Nilai Sub Kriteria</button>

	<?php
	echo form_close();
	?>
	
	<form style="display:inline-block" action="<?=base_url("")?>Sub_Kriteria/simpan_prioritas" method="post" accept-charset="utf-8">
		<?php
			$noUtama4=0;	
			foreach($arrs as $k4=>$v4)
			{
				...
				echo '<input type="hidden" class="form-control" name="id_sub_kriteria[]" value="'.$v4['id_sub_kriteria'].'"/>';
